...
const MyNftCard: FC<MyNftCardProps> = ({
  ...
  return (
    <div>
      ...
      {registedPrice ? (
        <div className="font-KCC text-xl text-center">{registedPrice} ETH</div>
      ) : (
        saleStatus && (
          <form className="text-center" onSubmit={onSubmitForSale}>
            <input
              type="text"
            ...
            />
            <input className="font-KCC text-xl" type="submit" value="submit" />
          </form>
        )
      )}
    </div>
